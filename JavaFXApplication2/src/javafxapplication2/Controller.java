...
public class Controller implements Initializable {
    ...
    void animacionV1(int i, Grua grua) {
        ...
        double iman_sujeto = contenido.get(indice).getY() - 100;
        ...
        ANIMACIONV.getChildren().addAll(V1, grua.DESPLAZAMIENTOV(Duration.millis(duracion_animacion * 100), -100, iman_sujeto));
    ...
    void animacionV2(int i, int j, Grua grua) {
        ...
        DESPLAZAMIENTOV.getChildren().addAll(transicion2, grua.DESPLAZAMIENTOV(Duration.millis(duracion_animacion * 100), 100, punto_cajaY));
    ...
    public void BURBUJA_animacionVH(int i, Grua grua, boolean cocktail) {
        ...
        VERTICAL2.getChildren().addAll(V1, grua.DESPLAZAMIENTOV(Duration.millis(duracion_animacion * 100), -100, iman_sujeto));
        ...
        VERTICAL3.getChildren().addAll(V2, grua.DESPLAZAMIENTOV(Duration.millis(duracion_animacion * 100), 100, punto_cajaY));
    ...
    public void BURBUJA_animacionVH2(int i, int j, Grua grua, boolean cocktail) {
        ...
        double iman_sujeto = contenido.get(indiceI).getY() - 100;
        ...
        VERTICALV2.getChildren().addAll(V1, grua.DESPLAZAMIENTOV(Duration.millis(duracion_animacion * 100), -100, iman_sujeto));
